...
**Last Updated**: Auto-generated by CI/CD; see README for local `dashboard:update`

### Pipeline Overview
- **Status**: ✅ Active and Optimized
- **Test Coverage**: ~98% (450+ tests passing)
...
jobs:
  update-dashboard:
    ...
    steps:
      ...
      - Install dependencies
      - Run tests with coverage
      - Generate dashboard data (`npm run dashboard:update`)
