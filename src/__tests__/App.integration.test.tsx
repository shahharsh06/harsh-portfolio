...
describe("App Integration Tests", () => {
  ...
  it("handles navigation between sections", async () => {
    ...
    try {
      ...
      const careerButton = screen.getByRole("button", {
        name: /career & education/i,
      });
  ...
  it("handles dashboard link", () => {
    ...
    const dashboardLinks = Array.from(screen.getAllByRole("link")).filter(
      (link) => link.getAttribute("href")?.includes("dashboard.html"),
    );
