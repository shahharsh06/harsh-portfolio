...
const Navigation = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 relative overflow-visible">
        ...
        {isMobileMenuOpen && (
          <>
            ...
            />
            {/* Mobile menu - positioned relative to navigation container with improved visibility */}
            <div className="md:hidden absolute top-full left-0 right-0 z-[9999] px-4 mt-2">
              <div className="px-2 pt-2 pb-3 space-y-1 bg-background/95 backdrop-blur-sm rounded-lg shadow-2xl border border-border">
