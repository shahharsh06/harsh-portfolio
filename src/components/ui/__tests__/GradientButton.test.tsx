...
describe("GradientButton Component", () => {
  ...
  it("applies custom className", () => {
    render(
      <GradientButton className="custom-class">Custom Button</GradientButton>,
    );
  ...
  it("handles click events", async () => {
    ...
    render(
      <GradientButton onClick={handleClick}>Clickable Button</GradientButton>,
    );
  ...
  it("maintains gradient styling when disabled", () => {
    render(<GradientButton disabled>Disabled Gradient</GradientButton>);
