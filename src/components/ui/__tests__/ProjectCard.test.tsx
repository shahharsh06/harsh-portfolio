...
vi.mock('../../SectionIcon', () => ({
  default: ({ icon, size, padding, interactive }: { icon: React.ReactNode; size?: string; padding?: string; interactive?: boolean }) => (
    <div data-testid="section-icon" data-size={size} data-padding={padding} data-interactive={interactive}>
      {icon}
    </div>
  )
}));
...
vi.mock('../SkillTag', () => ({
  default: ({ children, size, className }: { children: React.ReactNode; size?: string; className?: string }) => (
...
describe('ProjectCard Component', () => {
  ...
  it('renders featured project with image', () => {
    render(<ProjectCard {...defaultProps} featured={true} image="test-image.jpg" />);
  ...
  it('renders non-featured project without image', () => {
    render(<ProjectCard {...defaultProps} featured={false} image="test-image.jpg" />);
  ...
  it('handles many technologies for non-featured projects', () => {
    const manyTechs = ['React', 'TypeScript', 'Tailwind', 'Node.js', 'MongoDB', 'Express'];
  ...
  it('applies correct sizing for featured vs non-featured projects', () => {
    const { rerender } = render(<ProjectCard {...defaultProps} featured={false} />);
  ...
  it('handles very long project titles', () => {
    const longTitle = 'This is a very long project title that should be handled gracefully by the component without breaking the layout or causing any visual issues';
  ...
  it('handles very long descriptions', () => {
    const longDescription = 'This is a very long project description that should be handled gracefully by the component without breaking the layout or causing any visual issues. It should wrap properly and maintain readability.';
  ...
  it('handles special characters in project data', () => {
    const specialTitle = 'Project with special chars: @#$%^&*()_+-=[]{}|;:,.<>?';
  ...
  it('tests image loading state transitions', async () => {
    ...
    const { rerender } = render(<ProjectCard {...defaultProps} featured={true} image="test-image.jpg" />);
    ...
    rerender(<ProjectCard {...defaultProps} featured={true} image="new-image.jpg" />);
