...
describe('InteractiveCard Component', () => {
  it('renders with default props', () => {
    ...
    const card = screen.getByText('Test content').closest('div[class*="card-gradient"]');
  ...
  it('renders with custom className', () => {
    ...
    const card = screen.getByText('Test content').closest('div[class*="custom-class"]');
  ...
  it('renders with custom contentClassName', () => {
    ...
    const contentDiv = screen.getByText('Test content').closest('div[class*="custom-content-class"]');
  ...
  it('renders with title', () => {
    ...
    const card = screen.getByText('Test Title').closest('div[class*="card-gradient"]');
  ...
  it('renders with custom headerClassName', () => {
    ...
    const headerDiv = screen.getByText('Test Title').closest('div[class*="custom-header-class"]');
  ...
  it('applies custom padding to content', () => {
    ...
    const contentDiv = screen.getByText('Test content').closest('div[class*="p-8"]');
    expect(contentDiv).toBeInTheDocument();
  });
  ...
  it('renders with complex content structure', () => {
    ...
    const card = screen.getByText('Title').closest('div[class*="card-gradient"]');
  ...
  it('applies custom border radius', () => {
    ...
    const card = screen.getByText('Test content').closest('div[class*="rounded-xl"]');
  ...
  it('handles data attributes', () => {
    ...
    const card = screen.getByText('Test content').closest('div[class*="data-testid-custom-card"]');
