...
describe('CareerEducation Component', () => {
  ...
  it('displays section description', () => {
    ...
    const description = screen.getByText(/A chronological view of my academic and professional growth/);
  ...
  it('displays career timeline', () => {
    ...
    const careerTexts = screen.getAllByText((content, element) => {
      return element?.textContent?.includes('Engineer') || element?.textContent?.includes('Developer');
    });
