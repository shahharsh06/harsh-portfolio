...
describe('Navigation.utils', () => {
  describe('scrollToSection', () => {
    ...
    it('should handle null element gracefully', () => {
      ...
      expect(() => scrollToSection('#nonexistent', mockSetIsMobileMenuOpen)).not.toThrow();
      expect(mockSetIsMobileMenuOpen).toHaveBeenCalledWith(false);
    });
    ...
    it('should handle undefined href gracefully', () => {
      ...
      expect(() => scrollToSection(undefined as string, mockSetIsMobileMenuOpen)).not.toThrow();
      expect(mockSetIsMobileMenuOpen).toHaveBeenCalledWith(false);
    });
    ...
    it('should handle element without scrollIntoView method', () => {
      ...
      expect(() => scrollToSection('#test', mockSetIsMobileMenuOpen)).toThrow('element?.scrollIntoView is not a function');
