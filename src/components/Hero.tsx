            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl font-bold leading-tight relative inline-block">
                ...
                >
                  ...
                  <span className="opacity-0 select-none">Harsh Shah|</span>
              ...
              <p className="text-lg text-muted-foreground max-w-lg text-justify">
                Passionate about building intelligent systems and scalable
                applications. Master's in Computer Science graduate from Texas
                A&M University, with expertise in machine learning, data
                science, and software development.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <GradientButton onClick={scrollToContact} className="px-8 py-3">
                <Mail className="mr-2 h-4 w-4" />
                Get In Touch
              </GradientButton>
              <GradientButton className="px-8 py-3" asChild>
